...
class UserControllerTest {
    ...
    void create() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post(PATH)
                ...
                .content(getContentFromFile("user/response/request/create.json"))
        )
                .andExpect(MockMvcResultMatchers.status().isCreated())
                .andExpect(MockMvcResultMatchers.content().json(
                        getContentFromFile("user/response/create.json")
                ));
    ...
    void getAllUsers() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get(PATH))
                ...
                .andExpect(MockMvcResultMatchers.content().json(
                        getContentFromFile("user/response/all.json")
                ));
    ...
    void updateUser() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.patch(PATH_WITH_ID)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(getContentFromFile("user/response/request/update.json"))
                )
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.content().json(
                        getContentFromFile("user/response/update.json")
                ));
    }
