...
public interface BookingService {
    ...
    List<BookingEntity> getAll(Long userId, BookingState state, int from, int size);

    List<BookingEntity> getAllOwnerItems(Long userId, BookingState state, int from, int size);
