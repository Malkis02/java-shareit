...
public class BookingServiceTest {
    ...
    void setUp() {
        ...
        itemService = new ItemServiceImpl(itemRepository,userService,repository,
                itemMapper,commentMapper,commentRepository,requestRepository);
    ...
    void create() {
        ...
        var itemResult = itemService.create(itemMapper.mapToItemDto(item),userResult.getId());
    ...
    void getAll() {
        ...
        var userResult = userService.create(user);
        itemService.create(itemMapper.mapToItemDto(item),userResult.getId());
